...
| :--- | :--- | :--- | :--- |
| **EVID-01** | `Yasmin_Group_Inventory_Audit.E01` | Expert Witness Format (E01) | Forensic image of workstation `YGC-WS-014` |
...
* **Integrity Validation:** Verify the acquisition hashes (MD5/SHA-1) of `Yasmin_Group_Inventory_Audit.E01` before mounting or parsing data structures.
